...
\begin{table}[t]
  ...
  {\setlength{\tabcolsep}{4pt}
    \begin{tabu} to \textwidth {crclX[c]X[c]X[c]cc}
    	...
    	(\#) & Database & Ref.  & Scanner & (\si{\milli\second}) & (\si{\milli\second}) & (\si{\milli\second})     &   (\si{\milli\metre})      &   (\#)   \\ \midrule
    	 ...
    	 10  & \sname{10} {\sclr{10}$\blacksquare$} & \cite{MSSEG2008}  & 3T Siemens Allegra & 125  & 9000  & 2800 & $0.50\times0.50\times0.50$ & 1 \ss{e} \\ \bottomrule % chktex 2
    \end{tabu}}
  \tablepost{\ss{a}~Manuals were generated following the standards outlined in~\cite{Caligiuri2015},
    ...
    \ss{e}~Manuals were revised in-house (cf.~\S~\ref{ss:m08-rev}).}
\end{table}
\begin{figure}
  \centering
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{cv-box-leg}\\[0.5em]
  \begin{subfigure}{0.32\textwidth}
...
\par
With $Pr > Re$ for high LL, it can be inferred that % chktex 35
...
First, this is the only \qty{1.5}{\tesla} scanner in the dataset,
which implies higher levels of noise due to
smaller MR signal magnitude during image acquisition.
Second, the median LL for these subjects was only \qty{5}{\milli\litre},
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{ystd-box-leg}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{ovb-box-leg}\\[0.5em]
  \begin{subfigure}{0.32\textwidth}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{lam-box-leg}\\[0.5em]
  \begin{subfigure}{0.32\textwidth}
...
However, the Gaussian filter with $\sigma = 2$ MNI voxels (\qty{3}{\milli\metre})
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{beta-box-leg}\\[0.5em]
  \begin{subfigure}{0.32\textwidth}
...
\begin{figure}
  \centering
  \begin{subfigure}{\plotwidth}
    \includegraphics[width=\textwidth]{curve-pr-re}
    \caption{Precision-Recall Curve}%
    \label{fig:curve-pr-re}
  \end{subfigure}
  \begin{subfigure}{\plotwidth}
    \includegraphics[width=\textwidth]{curve-si}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{lpa-box-leg}\\[0.5em]
  \begin{subfigure}{0.32\textwidth}
    \centering
