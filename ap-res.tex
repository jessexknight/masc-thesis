...
in addition to one simulated T1 image (TE/TR = \SI{5/15}{\milli\second})
and one simulated T2 image (TE/TR = \SI{100/5500}{\milli\second}).
...
\begin{figure}
  ...
  \begin{subfigure}{0.27\textwidth}
    ...
    \caption{T2}
  \end{subfigure}
  \caption{Simulated T1 (TE/TR = \SI{5/15}{\milli\second})
  and T2 (TE/TR = \SI{100/5500}{\milli\second}) images.
