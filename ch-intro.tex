...
-- the cortex, approximately \qty{5}{\milli\metre} thick --
...
T1 and T2 values for various brain tissues at \qty{1.5}{\tesla}
...
\footnote{A more detailed and interactive version of this table is available at
  \hreftt{https://uoguelph-mlrg.github.io/vlr/wmh-table.html}}
\begin{table}
