...
\usepackage{lgrind,cmap,geometry,enumitem}          % fundamental packages
\usepackage{mathtools,amssymb,bm,upgreek,scrextend} % math packages
\usepackage{tabu,booktabs,multirow,multicol}        % table packages
\usepackage{graphicx,float,subcaption}              % figure packages
\usepackage{matlab-prettifier,listings,mdframed}    % code packages
\usepackage{nameref,xcolor,calc,tikz}               % beautify packages
\usepackage[hang, flushmargin]{footmisc}
\usepackage[colorlinks]{hyperref}
\usetikzlibrary{shapes,arrows.meta,calc}
\usepackage[backend=biber, style=numeric, maxcitenames=2, sorting=none,
            url=false, isbn=false, doi=true, eprint=false]{biblatex}
